        ...
        <image class="image" src="@/static/images/agency.png" style="width: 100%; height: 950" />
			...
			<view class="overview-top">
				<view class="top-left">
					<view class="fuli">
						...
						<view class="fuli_yu fuli_money"> <text class="tips">代金卷金额</text>￥1,000
						</view>
					</view>
					<!-- 			<view class="agent1">
				...
				<view class="top-right">
					<image class="top-right-image" src="../../static/icon/dkj.png" mode="widthFix"></image>
					<view>
						(最高可购买4张)
					</view>
				</view>
			...
			<view class="main">
				<view class="tabs-content">
					<view class="tabs">
										<text :class="activeIndex == index?' active item':'item'" v-for="(item, index) in couponTabs" :key="item.title" @tap="
					  () => {
					    activeIndex = index
					    item.isRender = true
					  }

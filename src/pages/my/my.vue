		...
		<view class="orders">
			...
			<view class="section">
				<uni-badge class="uni-badge-left-margin" text="" absolute="rightTop" size="small">
					<image class="order-icon" src="../../../src/static/icon/all_order.png" mode="widthFix"></image>
					<navigator :key="orderTypes[0].type" url="/pagesOrder/list/list?type=0" class="navigator"
						hover-class="none">

						全部
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.buyer.wait_count" absolute="rightTop"
					size="small">
					<image class="order-icon" src="../../../src/static/icon/not_order.png" mode="widthFix"></image>
					<navigator :key="orderTypes[0].type" :url="`/pagesOrder/list/list?type=${orderTypes[0].type}`"
						class="navigator" hover-class="none">

						{{ orderTypes[0].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.buyer.success_count" absolute="rightTop"
					size="small">
					<image class="order-icon" src="../../../src/static/icon/suc_order.png" mode="widthFix"></image>
					<navigator :key="orderTypes[1].type" :url="`/pagesOrder/list/list?type=${orderTypes[1].type}`"
						class="navigator" hover-class="none">
						{{ orderTypes[1].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.buyer.delivery_count" absolute="rightTop"
					size="small">
					<image class="order-icon" src="../../../src/static/icon/not_material_order.png" mode="widthFix">
					</image>
					<navigator :key="orderTypes[2].type" :url="`/pagesOrder/list/list?type=${orderTypes[2].type}`"
						class="navigator" hover-class="none">
						{{ orderTypes[2].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.buyer.received_count" absolute="rightTop"
					size="small">
					<image class="order-icon" src="../../../src/static/icon/material_order.png" mode="widthFix"></image>
					<navigator :key="orderTypes[3].type" :url="`/pagesOrder/list/list?type=${orderTypes[3].type}`"
						class="navigator" hover-class="none">
						{{ orderTypes[3].text }}
					</navigator>
				</uni-badge>
        ...
        >
          <uni-badge class="uni-badge-left-margin" :text="'0'" absolute="rightTop" size="small">
            {{ item.text }}
				...
				<uni-badge class="uni-badge-left-margin" text="" absolute="rightTop" size="small">
					<image class="order-icon" src="../../../src/static/icon/all_order.png" mode="widthFix"></image>
					<navigator :key="sellTypes[0].type" :url="`/pagesOrder/list/sellerlist?type=${sellTypes[0].type}`"
						class="navigator" hover-class="none">
						{{ sellTypes[0].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.seller.wait_count" absolute="rightTop"
					size="small">
					<image class="order-icon" src="../../../src/static/icon/not_order.png" mode="widthFix"></image>
					<navigator :key="sellTypes[1].type" :url="`/pagesOrder/list/sellerlist?type=${sellTypes[1].type}`"
						class="navigator" hover-class="none">
						{{ sellTypes[1].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.seller.confirm_count" absolute="rightTop"
					size="small">
					<image class="order-icon" src="../../../src/static/icon/suc_order.png" mode="widthFix"></image>
					<navigator :key="sellTypes[2].type" :url="`/pagesOrder/list/sellerlist?type=${sellTypes[2].type}`"
						class="navigator" hover-class="none">
						{{ sellTypes[2].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" :text="myOrderResutl?.seller.delivery_count"
					absolute="rightTop" size="small">
					<image class="order-icon" src="../../../src/static/icon/material_order.png" mode="widthFix"></image>
					<navigator :key="sellTypes[3].type" :url="`/pagesOrder/list/sellerlist?type=${sellTypes[3].type}`"
						class="navigator" hover-class="none">
						{{ sellTypes[3].text }}
					</navigator>
				</uni-badge>
				<uni-badge class="uni-badge-left-margin" text="" absolute="rightTop" size="small">
					<image class="order-icon" src="../../../src/static/icon/js_suc_order.png" mode="widthFix"></image>
					<navigator :key="sellTypes[0].type" :url="`/pagesOrder/list/sellerlist?type=${sellTypes[0].type}`"
						class="navigator" hover-class="none">
						已完成
					</navigator>

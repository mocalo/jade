<script setup lang="ts">
	import { queryCommissionLogList } from '@/services/commission'
	import { getCouponByTypeAPI } from '@/services/coupon'
	import type { CommissionListItem, CommissionResult } from '@/types/commission'
	...
	// 猜你喜欢的列表
	const guessList = ref<CommissionListItem[]>([])
	// 已结束标记
	...
	const getHomeGoodsGuessLikeData = async () => {
		...
		const res = await queryCommissionLogList(queryParams)
			...
			<view class="image">
				...
				<view class="image1">
					...
					<view class="text2">
						...
						<view class="text4"> <text class="price"></text>{{ item.money }} </view>
					</view>
				</view>
			</view>
		</navigator>

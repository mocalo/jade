    ...
    <template v-if="order">
      ...
      <view class="goods">
        ...
        <view class="total">
          <view class="row">
            ...
            <view class="symbol">{{ order.order_price }}</view>
          </view>
          <view class="row">
            <view class="text">应付金额: </view>
            <view class="symbol primary">{{ order.pay_cash }}</view>
          </view>
        </view>
      </view>
      ...
      <view class="detail">
        ...
        <view class="row">
          ...
          <view class="item">下单时间: {{ order.create_time }}</view>
          <view class="item">寄售人: {{ phoneNumShow(order.seller.mobile) }}</view>
        </view>
      </view>
      <view class="detail">
